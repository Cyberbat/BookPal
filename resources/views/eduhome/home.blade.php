  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="/storage/bckg/44d2b0790d52addc84c180bcce33a41c.jpg" alt="First slide">
      <div class="container">
              <div class="carousel-caption">
                <h1 style="color:cornsilk">Welcome to the Serious side of BookPal</h1>
                <p>Below you'll find a selection of books to exchange</p>
                <small>Photo : George Peabody Library</small>
                <div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-4 offset-md-1 py-4">
              <h4 class="text-white">Filter the Books through Course Type</h4>
            ...
            <li class="nav-item dropdown">
                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    Book type   <span class="caret"></span>
                </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">

                  @foreach (App\edugenre::all() as $genre)
                    <a class="dropdown-item" href="/edubooks/{{$genre->slug}}">{{$genre->name}}</a>
                    @endforeach
  ...
  >
    ...
    <ais-results>
      <template slot-scope="{ result }">
        <h2>
             <h2>
      <a :href="'/edubooks/'+result.edugenre_id+'/'+result.id">
        @{{ result.title }}
      </a>
    </h2>
        </h2>
