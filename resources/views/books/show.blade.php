                ...
                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                   <button class="btn btn-primary">Edit The Photos </button>
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <form method="POST" action="/api/books/{{$books->id}}/bookimage" enctype="multipart/form-data">
...
@if( auth()->user() !=$books->owner)
 <div class="container">
      ...
      <form method="POST" action="/profile/notifications/{{$books->owner->id}}/{{auth()->user()->id}}/{{$books->id}}">
